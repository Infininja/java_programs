public class Fraction
{
   ...
   public int getDenominator() 
   {
	...
	public void setNumerator(int myNumerator)
	{
	   this.myNumerator = myNumerator;
	}
   public void setDenominator(int myDenominator)
   {
      this.myDenominator = myDenominator;
	}
	public void multiply(Fraction other)
	{
		myNumerator = this.myNumerator * other.myNumerator;
		myDenominator = this.myDenominator * other.myDenominator;
	}	
